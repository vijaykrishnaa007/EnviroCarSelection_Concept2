...
public class MenuActivity extends ListActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        launchModelRendererActivity(Uri.parse("assets://" + getPackageName() + "/" + "models/dodge.obj"));//models/ToyPlane.obj
    }
        ...
        AssetUtils.createChooserDialog(this, "Select file", null, "models", "(?i).*\\.(obj|stl|dae|gltf)",
                (String file) -> {
                    if (file != null) {
                        ...
                        launchModelRendererActivity(Uri.parse("assets://" + getPackageName() + "/" + file));//models/ToyPlane.obj
                    }
                });
    }
